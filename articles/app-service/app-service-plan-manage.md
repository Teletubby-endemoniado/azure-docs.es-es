...
> [!TIP]
> Si no quiere crear un plan en una instancia de App Service Environment, puede seleccionarlo en la **región** y seguir el resto de los pasos, tal como se describe a continuación.
