...
>
> > [Inicio rápido: Aplicación web de ASP.NET Core que inicia la sesión de los usuarios y llama a una API web](web-app-quickstart.md?pivots=devlang-aspnet-core)
> 
