...
> [!div renderon="docs"]
> ¡Bienvenido! Probablemente esta no sea la página que esperaba. Actualmente estamos trabajando en una corrección, pero por ahora, use el vínculo siguiente; debería acceder al artículo correcto:
> 
> > [Inicio rápido: Aplicación Android con inicio de sesión de usuario](mobile-app-quickstart.md?pivots=devlang-android)
> 
